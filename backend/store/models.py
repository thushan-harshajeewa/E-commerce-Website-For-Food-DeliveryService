...
class Customer(models.Model):
    ...
    image=models.ImageField(upload_to='store/customer/images',default='NO',blank=True)
...
class OrderItem(models.Model):
    ...
    item_price_method = models.CharField(max_length=10,null=True)
...
class CartItem(models.Model):
    ...
    class Meta:
        unique_together=[['cart','product','item_price_method']]
...
class Reviews(models.Model):
    ...
    customer=models.ForeignKey(Customer,on_delete=models.CASCADE,null=True,related_name='reviews_customer')
